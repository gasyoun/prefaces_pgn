...
CODE = os.environ.get('DICT', 'pgn')
# PGN source language is English, so the base .md files ARE the English edition.
# (suffix, outfile, doc title, page-word, src-word)
LANGS = {
  'src': ('.md',    f'{CODE}pref_all.en.md', 'Front matter — complete (English, source language)', 'Page',     'Source (scan)'),
